...
async def get_link(user):
    ...
    conn.close()
    url = f"https://alfa.rbsuat.com/payment/rest/register.do?token=oj5skop8tcf9a8mmoh9ssb31ei&orderNumber={order_id}&amount={cart*100}&returnUrl=https://armada-wows-shop.ru/success"
